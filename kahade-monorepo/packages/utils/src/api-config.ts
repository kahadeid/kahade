 ...
 * 1. Using endpoints:
 * ```typescript
 * import { API_ENDPOINTS, buildApiUrl } from '@kahade/utils';
 * 
 * // Simple endpoint
 ...
 * import { API_BASE_URL, API_ENDPOINTS } from '@kahade/utils';
 * 
 ...
 * import { API_ENDPOINTS } from '@kahade/utils';
 * 
 * const { data } = useQuery(
 ...
 * 4. WebSocket:
 * ```typescript
 * import { buildWsUrl } from '@kahade/utils';
 * 
