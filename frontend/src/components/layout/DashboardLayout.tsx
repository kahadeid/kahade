      ...
      >
        ...
        <div className={cn(
          ...
          {!isSidebarCollapsed && (
            ...
            >
              <CaretRight className="w-4 aria-hidden="true" h-4 rotate-180 text-neutral-500" weight="bold" aria-hidden="true" />
            </button>
          )}
        </div>
        ...
        <div className={cn("p-4", isSidebarCollapsed && "px-3")}>
          <Link href="/transactions/new">
            <Button className={cn(
              ...
              <Plus className="w-5 aria-hidden="true" h-5" weight="bold" aria-hidden="true" />
        ...
        {isSidebarCollapsed && (
          <div className="p-3 border-t border-neutral-200">
            ...
            >
              <CaretRight className="w-5 aria-hidden="true" h-5 text-neutral-500" weight="bold" aria-hidden="true" />
            </button>
          </div>
        )}
          ...
          <div className="flex items-center justify-between h-full px-4 md:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <div className="hidden md:flex relative">
                <MagnifyingGlass className="absolute left-4 top-1/2 -translate-y-1/2 w-4 aria-hidden="true" h-4 text-neutral-500" />
                <Input
                  type="search"
                  placeholder="Search..."
                  value={searchQuery}
              ...
              <Link href="/notifications">
                <button className="relative p-2.5 hover:bg-neutral-100 rounded-xl transition-colors">
                  <Bell className="w-5 aria-hidden="true" h-5 text-neutral-600" weight="bold" aria-hidden="true" />
                    ...
                    <>
                      ...
                      >
                        ...
                        <div className="p-2">
                          ...
                          >
                            <User className="w-5 aria-hidden="true" h-5" weight="bold" aria-hidden="true" />
                          ...
                          <Link
                            ...
                            className="flex items-center gap-4 px-3 py-2.5 rounded-xl text-neutral-600 hover:text-neutral-900 hover:bg-neutral-100 transition-colors"
                          >
                            <Gear className="w-5 aria-hidden="true" h-5" weight="bold" aria-hidden="true" />
