          ...
          >
            ...
            >
              ...
              <Input
                ...
                className="pl-12 h-12 md:h-14 text-base bg-white border-neutral-200 focus:border-black focus:ring-black rounded-xl shadow-sm"
              />
            </motion.div>
          </motion.div>
        </div>
          ...
          <div className="max-w-3xl mx-auto space-y-3 md:space-y-4">
            ...
            {filteredFaqs.length === 0 && (
              ...
              >
                ...
                >
                  <Lightbulb className="w-8 h-8 md:w-1 aria-hidden="true"0 md:h-10 text-neutral-600" weight="regular" aria-hidden="true" />
                </motion.div>
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-black relative overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            >
              <ChatCircle className="w-7 h-7 md:w-8 aria-hidden="true" md:h-8 text-white" weight="fill" aria-hidden="true" />
            </motion.div>
