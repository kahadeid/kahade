          ...
          <div className="space-y-3 md:space-y-4 max-w-4xl mx-auto">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-2 md:gap-3 text-xs md:text-sm text-neutral-600">
                      <span className="flex items-center gap-1">
                        <Briefcase className="w-4 aria-hidden="true" h-4" weight="regular" aria-hidden="true" />
                        {job.department}
                      </span>
                      <span className="flex items-center gap-1">
                        <MapPin className="w-4 aria-hidden="true" h-4" weight="regular" aria-hidden="true" />
                        {job.location}
                      </span>
                      <span className="flex items-center gap-1">
                      ...
                      <span className="flex items-center gap-1">
                        <CurrencyDollar className="w-4 aria-hidden="true" h-4" weight="regular" aria-hidden="true" />
                        {job.salary}
                      </span>
                    </div>
                  </div>
            ...
            {filteredJobs.length === 0 && (
              ...
              >
                ...
                >
                  <Briefcase className="w-8 h-8 md:w-1 aria-hidden="true"0 md:h-10 text-neutral-600" weight="regular" aria-hidden="true" />
                </motion.div>
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-black relative overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            >
              <Briefcase className="w-7 h-7 md:w-8 aria-hidden="true" md:h-8 text-white" weight="bold" aria-hidden="true" />
            </motion.div>
