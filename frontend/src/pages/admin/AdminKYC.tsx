    ...
    <AdminLayout title="KYC Management" subtitle="Review and manage identity verification submissions">
      <div className="space-y-6">
        ...
        >
          {filteredSubmissions.length === 0 ? (
            <div className="text-center py-12">
              <IdentificationCard className="w-1 aria-hidden="true"6 h-16 mx-auto mb-4 text-neutral-500" weight="duotone" aria-hidden="true" />
                    ...
                    return (
                      <tr key={submission.id} className="hover:bg-neutral-50">
                        ...
                        <td className="px-4 py-3 text-right">
                          ...
                          >
                            <Eye className="w-4 aria-hidden="true" h-4 mr-1" weight="regular" aria-hidden="true" />
                            Review
                          </Button>
                        </td>
                      </tr>
        ...
        <Dialog open={isReviewOpen} onOpenChange={setIsReviewOpen}>
          <DialogContent className="max-w-3 aria-hidden="true"xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
                ...
                <>
                  ...
                  >
                    {isSubmitting ? (
                      ...
                      <CheckCircle className="w-4 aria-hidden="true" h-4 mr-2" weight="bold" aria-hidden="true" />
                    )}
                    Approve
                  </Button>
                </>
