            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-4 justify-center">
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Button className="h-11 md:h-12 px-5 md:px-6 bg-black text-white hover:bg-black/90 font-semibold rounded-xl">
                  <Envelope className="w-5 aria-hidden="true" h-5 mr-2" weight="bold" aria-hidden="true" />
                  Pertanyaan Media
                </Button>
              </motion.div>
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Button variant="outline" className="h-11 md:h-12 px-5 md:px-6 border-neutral-200 font-semibold rounded-xl">
                  <Download className="w-5 aria-hidden="true" h-5 mr-2" weight="bold" aria-hidden="true" />
                  Unduh Media Kit
                </Button>
              </motion.div>
            </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-4">
                  <div className="flex-1">
                    <div className="flex flex-wrap items-center gap-2 md:gap-3 mb-2">
                      ...
                      <span className="text-xs md:text-sm text-muted-foreground flex items-center gap-1">
                        <Calendar className="w-3.5 h-3.5 md:w-4 aria-hidden="true" md:h-4" weight="regular" aria-hidden="true" />
                        {release.date}
                      </span>
                    </div>
                  ...
                  <motion.div whileHover={{ x: 3 }} whileTap={{ scale: 0.95 }}>
                    <Button variant="ghost" className="h-9 md:h-10 gap-2 flex-shrink-0 text-black hover:text-neutral-600 rounded-lg">
                      Baca Selengkapnya
                      <ArrowRight className="w-4 aria-hidden="true" h-4" weight="bold" aria-hidden="true" />
                    </Button>
                  </motion.div>
                </div>
              </motion.article>
          ...
          <div className="grid sm:grid-cols-2 gap-4 md:gap-6 max-w-4xl mx-auto">
            {mediaFeatures.map((feature, index) => (
              ...
              >
                ...
                >
                  <Play className="w-6 h-6 md:w-7 aria-hidden="true" md:h-7 text-neutral-600 group-hover:text-white transition-colors" weight="fill" aria-hidden="true" />
                </motion.div>
                ...
                <motion.div whileHover={{ x: 3 }}>
                  <ArrowRight className="w-5 aria-hidden="true" h-5 text-muted-foreground group-hover:text-neutral-900 transition-colors flex-shrink-0" weight="bold" aria-hidden="true" />
                </motion.div>
              </motion.div>
            ))}
          </div>
            ...
            {mediaKitItems.map((item, index) => (
              ...
              >
                ...
                <span className="inline-flex items-center gap-1 text-xs text-black font-semibold">
                  <Download className="w-3 aria-hidden="true" h-3" weight="bold" aria-hidden="true" />
                  {item.format}
                </span>
              </motion.div>
            ))}
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-black relative overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            >
              <Envelope className="w-7 h-7 md:w-8 aria-hidden="true" md:h-8 text-white" weight="bold" aria-hidden="true" />
            </motion.div>
