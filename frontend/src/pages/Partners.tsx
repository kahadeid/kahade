          ...
          <div className="max-w-4xl mx-auto text-center px-4">
            ...
            >
              <span className="inline-flex items-center gap-2 px-4 py-2 bg-black/5 rounded-full text-sm font-medium text-black">
                <Handshake className="w-4 aria-hidden="true" h-4" weight="fill" aria-hidden="true" />
            ...
            >
              ...
              <Button className="h-14 px-8 border-2 border-black/20 hover:border-neutral-900 hover:bg-black/5 rounded-xl font-semibold">
                <BookOpen className="mr-2 w-5 aria-hidden="true" h-5" weight="bold" aria-hidden="true" />
                Lihat API Docs
              </Button>
            </motion.div>
          </div>
            ...
            {paymentPartners.map((partner, index) => (
              ...
              >
                <div className="w-16 h-16 rounded-lg bg-white border border-neutral-200 flex items-center justify-center mb-3">
                  <CreditCard className="w-8 aria-hidden="true" h-8 text-black" weight="duotone" aria-hidden="true" />
                </div>
            ...
            {bankPartners.map((bank, index) => (
              ...
              >
                <div className="w-14 h-14 rounded-lg bg-blue-50 border-2 border-blue-100 flex items-center justify-center mb-3">
                  <Bank className="w-7 aria-hidden="true" h-7 text-blue-600" weight="duotone" aria-hidden="true" />
                </div>
                ...
                <ul className="space-y-4 mb-8">
                  {partnerBenefits.map((benefit, index) => (
                    <li key={index} className="flex items-center gap-3">
                      <Check className="w-6 aria-hidden="true" h-6 text-black" weight="bold" aria-hidden="true" />
