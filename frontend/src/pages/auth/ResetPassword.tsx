/*
 * KAHADE RESET PASSWORD PAGE - Professional Version
      ...
      <div className="min-h-screen flex items-center justify-center bg-white p-6">
        ...
        >
          <div className="w-20 h-20 rounded-full bg-red-100 flex items-center justify-center mx-auto mb-6">
            <Warning className="w-10 h-10 text-red-600" aria-hidden="true" weight="duotone" />
          </div>
      ...
      <div className="min-h-screen flex items-center justify-center bg-white p-6">
        ...
        >
          <div className="w-20 h-20 rounded-full bg-emerald-100 flex items-center justify-center mx-auto mb-6">
            <CheckCircle className="w-10 h-10 text-emerald-600" aria-hidden="true" weight="duotone" />
          </div>
    ...
    <div className="min-h-screen flex bg-white">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12 lg:px-12 xl:px-20">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="w-16 h-16 rounded-lg bg-black flex items-center justify-center mb-6">
            <Key className="w-8 h-8 text-white" aria-hidden="true" weight="duotone" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-neutral-500" aria-hidden="true" weight="regular" />
                <Input
                  id="password"
                  ...
                  className={`pl-10 pr-10 bg-white border-neutral-200 focus:border-black focus:ring-black h-12 ${errors.password ? 'border-red-500' : ''}`}
                />
                <button
                  type="button"
                ...
                >
                  {showPassword ? <EyeSlash className="w-5 h-5" aria-hidden="true" weight="regular" /> : <Eye className="w-5 h-5" aria-hidden="true" weight="regular" />}
                </button>
              </div>
              {errors.password && (
                  ...
                  {['8+ characters', 'Uppercase', 'Lowercase', 'Number', 'Special char'].map((req) => {
                    ...
                    return (
                      <span key={req} className={`text-xs px-2 py-1 rounded-full flex items-center gap-1 ${isPassed ? 'bg-emerald-50 text-emerald-600' : 'bg-gray-100 text-gray-500'}`}>
                        {isPassed ? <Check className="w-3 h-3" aria-hidden="true" weight="bold" /> : <X className="w-3 h-3" weight="bold" aria-hidden="true" />}
                        {req}
                      </span>
                    );
                  })}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                {formData.confirmPassword && formData.password === formData.confirmPassword && (
                  <Check className="absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-emerald-500" aria-hidden="true" weight="bold" />
                )}
              </div>
            ...
            >
              {isSubmitting ? (
                <>
                  <Spinner className="mr-2 w-5 h-5 animate-spin" aria-hidden="true" weight="bold" />
                  Resetting password...
                </>
              ) : (
                <>
          ...
          <div className="mt-8 pt-8 border-t border-neutral-200">
            <div className="flex items-center justify-center gap-6 text-xs text-neutral-500">
              ...
              <div className="flex items-center gap-1">
                <Lock className="w-4 h-4" aria-hidden="true" weight="fill" />
                <span>Encrypted</span>
              </div>
            </div>
          </div>
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center p-12 bg-black relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10" aria-hidden="true">
          <div className="absolute top-0 left-0 w-full h-full" aria-hidden="true" style={{
        ...
        >
          <div className="w-32 h-32 mx-auto mb-8 rounded-lg bg-white/10 flex items-center justify-center backdrop-blur-sm">
            <ShieldCheck className="w-16 h-16 text-white" aria-hidden="true" weight="duotone" />
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 text-left">
            ...
            <ul className="space-y-3 text-white/70 text-sm">
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" aria-hidden="true" weight="fill" />
