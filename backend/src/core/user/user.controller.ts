...
export class UserController {
  ...
  @ApiResponse({ status: 202, description: "Data export requested" })
...
// ============================================================================
// USERS CONTROLLER - Public User Lookup (Now Authenticated)
// ============================================================================
...
export class UsersController {
  ...
  @Get("validate-email")
  @Throttle({ default: { limit: 10, ttl: 3600000 } }) // 10 requests per hour - strict rate limit
  @ApiOperation({
    summary: "Validate user email for transaction",
    description: "Requires authentication. Rate limited to prevent email enumeration."
  })
  ...
  async validateEmail(
    ...
    // Don't allow creating transaction with yourself
