...
import { OrderFilterDto, OrderFilterExtendedDto } from "./dto/order-filter.dto";
...
export class OrderService {
  ...
  async createOrder(
    ...
    return {
      ...
      data: {
        ...order,
        inviteLink: `${this.configService.get("app.frontendUrl")}/transactions/accept/${inviteToken}`,
      },
    };
  }
