...
export class CookieUtil {
  private static readonly ACCESS_TOKEN_COOKIE = "kahade_access_token";
  private static readonly REFRESH_TOKEN_COOKIE = "kahade_refresh_token";
  ...
  /**
   * Set CSRF token in HttpOnly cookie (token is also returned in response header)
   */
  static setCsrfToken(
    res: Response,
    token: string,
